...
func CommonProcessClearCache(cardMsg CardMsg, session services.SessionServiceCacheInterface) (
	...
	if cardMsg.Value == "1" {
		...
		newCard, _ := newSendCard(
			withHeader(utils.I18n.Sprintf("️🆑 机器人提醒"), larkcard.TemplateGrey),
			withMainMd(utils.I18n.Sprintf("已删除此话题的上下文信息")),
			withNote(utils.I18n.Sprintf("我们可以开始一个全新的话题，继续找我聊天吧")),
		)
